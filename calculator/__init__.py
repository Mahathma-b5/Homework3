'''calculations'''
from calculator.calculations import Calculations  # type: ignore # Manages history of calculations
from calculator.operations import add, subtract, multiply, divide  # type: ignore # Arithmetic operations
from calculator.calculation import Calculation  # type: ignore # Represents a single calculation
